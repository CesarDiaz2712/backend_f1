...
public class ContractDriverRepositoryTest {
    ...
    public void init(){
        ...
        driverWithContractNoActivated = driverHelper.createDriverFormulaCustom("Cesar", "Alejo", "Stricline893131a", "27", userByDriverActivated);
        ...
        Date initialDateContract;
        Date finalContractDate;
        
            initialDateContract = formatter.parse("2024-04-23");
            finalContractDate = formatter.parse("2024-12-01");
            
            contractDriverRepository.save(ContractDriver.instance(driverWithContractActivated, team, initialDateContract, finalContractDate, new Date(), null));
            
            contractDriverRepository.save(ContractDriver.instance(driverWithContractNoActivated, team, initialDateContract, finalContractDate, new Date(), null, false));
    ...
    public void createContractDriver(){
        ...
        try {
            ...
            initialDateContract = formatter.parse("2024-04-23");
            finalContractDate = formatter.parse("2024-12-01");
            ContractDriver contractDriver = contractDriverRepository.save(ContractDriver.instance(driverWithContractActivated, team, initialDateContract, finalContractDate, new Date(), null));
    ...
    public void findContractDriverByContractDriverKeyAndStatusNonActivatedSuccess(){
        ContractDriverKey key  =new ContractDriverKey(driverWithContractNoActivated.getId(), team.getId());
         Optional<ContractDriver> optionalContract = contractDriverRepository.findContractDriverByContractDriverKeyAndStatus(key, false);
